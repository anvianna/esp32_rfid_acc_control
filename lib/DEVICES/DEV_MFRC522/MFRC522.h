/**
 * @file MFRC522.h
 * @author André Vianna (andre.n.vianna@outlook.com/andre.v@fieb.org.br )
 * @brief Library Adapted from Miguel Balboa RFID Arduino Library to ESP32 
 * @version 0.1
 * @date 20-11-2024
 * 
...
public:
	...
	// Constructor for SELENE LIKE FUNCTION
	#endif
	MFRC522(void * spi_handle, void *reset_gpio_handle);
	...
	// Supressed //const char *GetStatusCodeName(byte code);
	//static const __FlashStringHelper *GetStatusCodeName(StatusCode code);
	static PICC_Type PICC_GetType(byte sak);
	// old function used too much memory, now name moved to flash; if you need char, copy from flash to memory
	//const char *PICC_GetTypeName(byte type);
	// Supressed static const __FlashStringHelper *PICC_GetTypeName(PICC_Type type);
